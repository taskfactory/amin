...
func (obj *AdminService) GetSources(req *GetSourcesReq, opts ...map[string]string) (ret GetSourcesRsp, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *AdminService) GetSourcesWithContext(tarsCtx context.Context, req *GetSourcesReq, opts ...map[string]string) (ret GetSourcesRsp, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *AdminService) GetSourcesOneWayWithContext(tarsCtx context.Context, req *GetSourcesReq, opts ...map[string]string) (ret GetSourcesRsp, err error) {
	var (
		length int32
		have   bool
		ty     byte
...
func (obj *AdminService) TarsSetTimeout(timeout int) {
	obj.servant.TarsSetTimeout(timeout)
}

// TarsSetProtocol sets the protocol for the servant.
func (obj *AdminService) TarsSetProtocol(p m.Protocol) {
	obj.servant.TarsSetProtocol(p)
}

// AddServant adds servant  for the service.
func (obj *AdminService) AddServant(imp AdminServiceServant, servantObj string) {
	tars.AddServant(obj, imp, servantObj)
}

// AddServantWithContext adds servant  for the service with context.
func (obj *AdminService) AddServantWithContext(imp AdminServiceServantWithContext, servantObj string) {
...
func (obj *AdminService) Dispatch(tarsCtx context.Context, val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, withContext bool) (err error) {
	var (
		length int32
		have   bool
		ty     byte
